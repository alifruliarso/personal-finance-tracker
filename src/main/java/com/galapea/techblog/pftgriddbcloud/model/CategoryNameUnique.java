...
@Documented
@Constraint(validatedBy = CategoryNameUnique.CategoryNameUniqueValidator.class)
public @interface CategoryNameUnique {
	...
	class CategoryNameUniqueValidator implements ConstraintValidator<CategoryNameUnique, String> {
		...
		public CategoryNameUniqueValidator(
		...
		public boolean isValid(final String value, final ConstraintValidatorContext cvContext) {
			...
			if (currentId != null
					&& value.equalsIgnoreCase(categoryService.get(currentId).getName())) {
